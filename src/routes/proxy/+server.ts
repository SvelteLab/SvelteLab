 ...
 * somethign we need to that request the header Cross-Origin-Resource-Policy
 * set to cross-origin. With this proxy we can easily pass an url
 * and it will append the correct header
 */
