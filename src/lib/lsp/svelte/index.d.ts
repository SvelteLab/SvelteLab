...
type LanguageServerClientOptions = Exclude<ConstructorParameters<typeof LanguageServerClient>["0"], "transport">;
...
declare class WorkerRPC extends PostMessageWorkerTransport {
     ...
     */
    constructor(worker: URL, options: Omit<LanguageServerClientOptions, "transport">);
    /**
     ...
     *
     */
    constructor(worker: Worker, options: Omit<LanguageServerClientOptions, "transport">);
    /**
